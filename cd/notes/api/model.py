...
class ContrastiveLoss(nn.Module):
    ...
    def forward(self, output1, output2, label):
        ...
        return loss_contrastive,{
            'euclidean_distance': euclidean_distance.item(),  # Convert to scalar
            'scaled_distance': scaled_distance.item(),       # Convert to scalar
            'loss_contrastive': loss_contrastive.item()      # Convert to scalar
        }
